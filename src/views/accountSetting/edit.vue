<template>
    ...
    <div class="w-1/1 h-17/19 px-20 pt-8 bg-white rounded-md shallow">
        <el-form
            ...
            <el-form-item label="添加时间" prop="createDate">
                <el-input v-model="formData.createDate" :value="timeChange(formData.createDate)" clearable/>
            </el-form-item>
            <br>
            <br>
    ...
    border-radius: 4px;">
            ...
            <el-form-item>
                ...
                <el-button style="background-color: #00bd77;color: #fff" @click="submitUpload(ruleFormRef)">上传
                </el-button>
            </el-form-item>
        </el-form>
    </div>
